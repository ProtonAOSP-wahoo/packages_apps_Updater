 ...
 */
package org.protonaosp.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.build.version.custom";
    public static final String PROP_BUILD_VARIANT = "ro.build.variant";
    public static final String PROP_DEVICE = "ro.build.version.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "protonaosp.updater.allow_downgrading";
